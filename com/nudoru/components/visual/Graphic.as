package com.nudoru.components.visual
{
	...
	import com.nudoru.components.service.ImageLoader;
	...
	addChild(graphic);
	 */
	public class Graphic extends VisualComponent implements IVisualComponent
	{
		...
		override public function initialize(data:*=null):void
		{
			...
			if(data.border is String)
			{
				...
				if(_borderStyle && ! _borderSize) _borderSize = ComponentSettings.borderSize;
				if(_borderSize && ! _borderStyle) _borderStyle = ComponentSettings.borderStyle;
		...
		protected function renderImage():void
		{
			...
			if(_animate)
			{
				...
				TweenMax.to(_containerSprite, .75, {alpha:1, colorTransform:{exposure:1}, ease:Expo.easeOut});
			}
