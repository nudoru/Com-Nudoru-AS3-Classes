package com.nudoru.components.visual
{
	...
	calendar.render();
	 */
	public class ScatterCalendar extends VisualComponent implements IVisualComponent
	{
		...
		public var nextmonth_btn:Object;
		public var prevmonth_btn:Object;
		...
		{
			return DateTimeUtils.getMonth(_currentMonth);
		}

		public function get currentCalendarData():Array
		{
			return DateTimeUtils.getCalendarDayObjects(_currentYear, _currentMonth);
		}
