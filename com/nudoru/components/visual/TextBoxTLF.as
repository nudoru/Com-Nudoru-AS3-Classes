package com.nudoru.components.visual 
{
	 ...
	 * Sample:
			...
			this.addChild(text);
	 */
	public class TextBoxTLF extends TextBox implements IVisualComponent
	{
		...
		public function TextBoxTLF():void
		{
			...
			trace("TEXTBOXTLF IS DEPRECIATED")
		}
		...
		override public function render():void
		{
			...
			if (_scroll && _height)
			{
				...
				_scrollArea.initialize( {barsize:ComponentSettings.scrollBarSize, content:_container, orientation:ScrollPane.VERTICAL, width:_width, height:_height} );
				_scrollArea.render();
