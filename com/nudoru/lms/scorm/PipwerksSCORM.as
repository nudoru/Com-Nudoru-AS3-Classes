...
package com.nudoru.lms.scorm {
	...
	public class PipwerksSCORM {
		
		private var __connectionActive:Boolean = false;
		private var __debugActive:Boolean = true;
	
	
		public function PipwerksSCORM() {
		...
		private function __displayDebugInfo(msg:String):void {
			Debugger.instance.add("PIPWERKS: "+msg, this);
			if(__debugActive){
				//trace(msg);
				if(ExternalInterface.available) ExternalInterface.call("pipwerks.UTILS.trace", msg);
			}
		}
