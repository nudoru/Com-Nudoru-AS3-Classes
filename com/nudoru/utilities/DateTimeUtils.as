package com.nudoru.utilities
{
	...
	public class DateTimeUtils
	{
		...
		// idea from here http://www.codingforums.com/showthread.php?t=46860
		public static function convertSecondsToHHMMSS(seconds:Number):String
		{
			...
			var ms:Number = d.getMilliseconds();
			var hhmmss:String="";
			//hhmmss += paddedStringOfIntBelowTen(h);
			hhmmss += paddedStringOfIntBelowTen(m);
			hhmmss += ":"+paddedStringOfIntBelowTen(s);
			//hhmmss += "."+paddedStringOfIntBelowTen(ms);
			return hhmmss;
		}
		
		private static function paddedStringOfIntBelowTen(number:int):String
		{
